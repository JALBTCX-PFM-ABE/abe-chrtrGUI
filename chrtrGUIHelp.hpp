...
QString runText = 
  chrtrGUI::tr ("Pressing this button will begin the gridding process.  The gridding process is not actually a "
...
QString saveText = 
  chrtrGUI::tr ("Pressing this button will allow you to save the parameters that you have input to this GUI in "
